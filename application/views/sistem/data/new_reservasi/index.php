				...
				<div class="row">
						...
						<a class="btn  btn-primary pull-left" href="<?=base_url()?>sistem/new_reservasi_tambah" >
											...
											<tbody>
														...
														<tr >
															...
															<td>
																...
																<a  class="btn btn-success" href="<?php echo base_url();?>sistem/new_reservasi_in/<?php echo $tampil['id_reservasi'];?>/1">Proses Check IN</a> 
																<?php
																}
																else if ($tampil['status_reservasi']=="1") { ?>

																<a  class="btn btn-danger" href="<?php echo base_url();?>sistem/new_reservasi_out/<?php echo $tampil['id_reservasi'];?>/2" >Proses Check Out</a>
